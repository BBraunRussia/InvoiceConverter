...
namespace InvoiceConverter.Domain.Companies
{
    ...
    {        
        ...
        public override void CreateAndSaveFile()
        {
            ...
            node4.InnerText = _docXML.post.ReplaceSimbol();
            node.AppendChild(node4);
            XmlNode node5 = doc.CreateElement("Получатель");
            node5.InnerText = _docXML.pokup.ReplaceSimbol();
            ...
            node13.InnerText = _docXML.gruzopoluchatel.ReplaceSimbol();
            ...
            node18.InnerText = _docXML.address.ReplaceSimbol();
            ...
            node25.InnerText = _docXML.city.ReplaceSimbol();
            node17.AppendChild(node25);
            XmlNode node26 = doc.CreateElement("Банк");
            node26.InnerText = _docXML.bank.ReplaceSimbol();
